...
export function getStoragePrefKey(dataType: 'bookmark' | 'column' | 'draft'): string {
  switch (dataType) {
    case 'bookmark':
...
export type StoragePrefKey = typeof STORAGE_PREF_KEYS[keyof typeof STORAGE_PREF_KEYS];