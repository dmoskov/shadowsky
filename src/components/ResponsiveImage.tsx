...
export const ResponsiveImage: React.FC<ResponsiveImageProps> = ({
  ...
  if (imageError) {
    return (
      <div
        className={`flex items-center justify-center rounded-lg bg-bsky-bg-tertiary ${maxHeight} ${getAspectRatioClass()} ${className}`}
      >
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-lg bg-bsky-bg-tertiary ${getAspectRatioClass()} ${className}`}
    >
      {isLoading && (
