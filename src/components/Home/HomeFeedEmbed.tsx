...
export const HomeFeedEmbed: React.FC<HomeFeedEmbedProps> = React.memo(
  ({ embed, postUri, postIndex, onImageGalleryOpen, onQuotePostClick }) => {
      ...
      return (
        <ImageGrid
          ...
          onImageClick={(index) => {
            ...
            onImageGalleryOpen(images, index);
          }}
        />
      );
    }
            ...
            <div
              ...
              onClick={(e) => {
                ...
                if (quotedPost.uri && quotedPost.author) {
                  onQuotePostClick({ uri: quotedPost.uri } as Post);
                }
              }}
            >
