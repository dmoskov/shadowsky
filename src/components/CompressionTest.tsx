...
export function CompressionTest() {
  ...
  return (
    <div className="p-4">
      <h1 className="mb-4 text-2xl font-bold">Image Compression Test</h1>
      ...
      {loading && (
        <div className="text-lg">Processing compression methods...</div>
      )}

      {results.length > 0 && (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {results.map((result, i) => (
            <div key={`compression-result-${result.name}-${i}`} className="rounded border p-4">
