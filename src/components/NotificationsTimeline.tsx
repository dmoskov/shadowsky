    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p style={{ color: "var(--bsky-text-secondary)" }}>
          Your notifications organized by day
        </p>
      </div>
      ...
      <div className="space-y-8">
        {groupedNotifications.map(({ date, notifications }) => (
          <div key={date.toISOString()}>
            <div
              className="sticky top-16 z-10 py-2"
            ...
            <div className="mt-4 space-y-2">
              {notifications.map((notification) => (
                <div
                  ...
                  className="bsky-card-hover flex gap-4 rounded-lg p-3 transition-colors"
                >
                  <div
                    className="w-16 flex-shrink-0 pt-1 text-xs"
                  ...
                  <div className="flex flex-1 items-start gap-3">
                    {notification.author.avatar ? (
                      ...
                      <div
                        ...
                        style={{ backgroundColor: "var(--bsky-bg-hover)" }}
                      >
