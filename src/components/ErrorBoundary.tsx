                ...
                <div className="flex w-full gap-2">
                  {showGoBack && (
                    <button
                      ...
                      className="touch-target-sm flex flex-1 items-center justify-center gap-2 rounded-lg border border-asph-border-secondary bg-asph-bg-secondary px-4 py-2.5 font-medium text-asph-text-secondary transition-colors hover:bg-asph-bg-hover"
                  ...
                  <button
                    ...
                    className={`touch-target flex ${showGoBack ? "flex-1" : "w-full"} items-center justify-center gap-2 rounded-lg border border-asph-border-secondary bg-asph-bg-secondary px-4 py-2.5 font-medium text-asph-text-secondary transition-colors hover:bg-asph-bg-hover`}
