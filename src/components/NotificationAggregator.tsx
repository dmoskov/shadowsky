      ...
      const getNotificationTypeLabel = (reason: string): string => {
        switch (reason) {
          ...
          case "quote":
            return "Quotes";
          case "starterpack-joined":
            return "Starterpack Joins";
          case "like-via-repost":
            return "Likes via Repost";
          case "repost-via-repost":
            return "Reposts via Repost";
          default:
            return reason.charAt(0).toUpperCase() + reason.slice(1) + "s";
        }
      };
                  ...
                  >
                    {user.avatar ? (
                      <img
                        ...
                        alt={user.handle}
                        className="bsky-avatar h-8 w-8 border-2"
                        style={{ borderColor: "var(--bsky-bg-primary)" }}
                      />
                    ) : (
                      <div
                        className="bsky-avatar flex h-8 w-8 items-center justify-center border-2"
                        style={{
