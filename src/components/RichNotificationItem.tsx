        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-start justify-between gap-2">
            <p className="text-sm">
              ...
              >
                ·{" "}
                {formatDistanceToNow(new Date(notification.latestTimestamp), {
                  addSuffix: true,
                })}
              </span>
            </p>
...
const NotificationIcon: React.FC<{ reason: string }> = React.memo(({ reason }) => {
  ...
  switch (reason) {
    ...
    case "repost":
      return <Repeat2 {...iconProps} style={{ color: "var(--bsky-repost)" }} />;
    case "follow":
      return (
        <UserPlus {...iconProps} style={{ color: "var(--bsky-follow)" }} />
      );
    case "mention":
      return <AtSign {...iconProps} style={{ color: "var(--bsky-mention)" }} />;
    case "reply":
      return (
        <MessageCircle {...iconProps} style={{ color: "var(--bsky-reply)" }} />
      );
    case "quote":
