...
export const FloatingActionButton: React.FC<FloatingActionButtonProps> = ({
  ...
  return (
    <button
      onClick={handleClick}
      className={`touch-target ios-press fixed bottom-20 right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full shadow-lg lg:bottom-6 lg:right-6 ${prefersReducedMotion ? "" : "transition-all duration-300"} ${className}`}
      style={{
