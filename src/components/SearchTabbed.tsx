  ...
  const {
    ...
    queryFn: async () => {
      ...
      try {
        ...
        const allFeeds = [...popularResponse.data.feeds, ...suggestedResponse.data.feeds];
        ...
        const response = await atProtoClient.agent.app.bsky.feed.getSuggestedFeeds({
          limit: 100,
        });
  ...
  return (
    <div className="mx-auto min-h-screen max-w-4xl p-4">
      ...
      {showThreadViewer ? (
        ...
        <>
          {/* Search Container */}
          <div className="bsky-glass rounded-xl">
            {/* Search Input */}
            <div className="border-b p-3 sm:p-4" style={{ borderColor: "var(--bsky-border-primary)" }}>
            ...
            <div className="flex gap-0">
              ...
              >
                <FileText size={16} />
                Posts
                {activeTab === "posts" && postsSearchResults?.posts && postsSearchResults.posts.length > 0 && (
                  <span 
              ...
              >
                <Users size={16} />
                Users
                {activeTab === "users" && usersSearchResults?.actors && usersSearchResults.actors.length > 0 && (
                  <span 
                    className="ml-1 rounded-full px-1.5 py-0.5 text-xs font-normal"
                    style={{ 
                      backgroundColor: "var(--bsky-primary)",
                  ...
                  >
                    {usersSearchResults.actors.filter(
                      (user) =>
                        !isUserMuted(user.did) &&
                        !isUserBlocked(user.did),
                    ).length}
                  </span>
                )}
                {activeTab === "users" && (
              ...
              >
                <List size={16} />
                Feeds
                {activeTab === "feeds" && feedsSearchResults?.feeds && feedsSearchResults.feeds.length > 0 && (
                  <span 
                    className="ml-1 rounded-full px-1.5 py-0.5 text-xs font-normal"
                    style={{ 
                      backgroundColor: "var(--bsky-primary)",
            ...
            {activeTab === "posts" && filters.from.length === 0 &&
            !filters.sinceDate &&
            !filters.untilDate &&
            ...
            {activeTab === "posts" && searchQuery && searchQuery !== filters.query && (
              <div
          ...
          <div className="space-y-3">
            {!activeSearchQuery && !isLoading && (
              <div className="rounded-xl border bg-white bg-opacity-5 p-8 text-center" style={{ borderColor: "var(--bsky-border-primary)" }}>
                <SearchIcon
                  size={48}
            ...
            {error && (
              <div className="rounded-xl border bg-red-500 bg-opacity-5 p-6 text-center" style={{ borderColor: "var(--bsky-error)" }}>
                <p
                  className="text-sm"
                  style={{ color: "var(--bsky-error)" }}
                >
            ...
            {/* Posts Results */}
            {activeTab === "posts" && searchResults && postsSearchResults?.posts.length === 0 && (
              <div className="rounded-xl border bg-white bg-opacity-5 p-6 text-center" style={{ borderColor: "var(--bsky-border-primary)" }}>
                <FileText
                  size={32}
            ...
            {activeTab === "posts" && searchResults && postsSearchResults?.posts && postsSearchResults.posts.length > 0 && (
              <>
            ...
            {/* Users Results */}
            {activeTab === "users" && searchResults && usersSearchResults?.actors.length === 0 && (
              <div className="rounded-xl border bg-white bg-opacity-5 p-6 text-center" style={{ borderColor: "var(--bsky-border-primary)" }}>
                <Users
                  size={32}
                  className="mx-auto mb-3 opacity-10"
            ...
            {activeTab === "users" && searchResults && usersSearchResults?.actors && usersSearchResults.actors.length > 0 && (
              <>
                <div className="mb-2 flex items-center justify-between">
                  <p
                    className="text-sm"
            ...
            {/* Feeds Results */}
            {activeTab === "feeds" && searchResults && feedsSearchResults?.feeds.length === 0 && (
              <div className="rounded-xl border bg-white bg-opacity-5 p-6 text-center" style={{ borderColor: "var(--bsky-border-primary)" }}>
                <List
                  size={32}
                  className="mx-auto mb-3 opacity-10"
            ...
            {activeTab === "feeds" && searchResults && feedsSearchResults?.feeds && feedsSearchResults.feeds.length > 0 && (
              <>
                <div className="mb-2 flex items-center justify-between">
                  <p
                    className="text-sm"
