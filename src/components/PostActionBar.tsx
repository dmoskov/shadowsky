    ...
    return (
      ...
      >
        ...
        <div className="relative">
          <button
            ref={repostButtonRef}
            className={`touch-target-sm relative flex cursor-pointer items-center gap-1.5 rounded-md border-none bg-transparent p-2 text-bsky-text-secondary transition-all duration-150 hover:scale-110 hover:text-green-600 ${
        ...
        {/* Like */}
        <button
          className={`touch-target-sm relative flex cursor-pointer items-center gap-1.5 rounded-md border-none bg-transparent p-2 text-bsky-text-secondary transition-all duration-150 hover:scale-110 hover:text-red-600 ${
        ...
        {/* Bookmark */}
        <button
          className={`touch-target-sm relative flex cursor-pointer items-center gap-1.5 rounded-md border-none bg-transparent p-2 text-bsky-text-secondary transition-all duration-150 hover:scale-110 hover:text-amber-600 ${
