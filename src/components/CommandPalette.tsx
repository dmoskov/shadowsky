...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose }) => {
  ...
  const commands = useMemo<Command[]>(() => [
    ...
    },
    {
      ...
      action: () => {
        toggleTheme();
        trackFeatureAction("theme_toggled", { newTheme: theme === "dark" ? "light" : "dark" });
      }
    },
  ...
  ], [navigate, onClose, logout, session, theme, toggleTheme, trackFeatureAction]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-20">
      ...
      >
        <div className="flex items-center gap-3 border-b px-4 py-3" style={{ borderColor: "var(--bsky-border-primary)" }}>
                ...
                {sectionCommands.map((cmd) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ 
                        backgroundColor: isSelected ? "var(--bsky-primary)" : "transparent",
                        color: isSelected ? "var(--bsky-text-primary)" : "var(--bsky-text-secondary)"
                      }}
                      onClick={() => {
                        trackFeatureAction("command_executed", { commandId: cmd.id });
                        cmd.action();
                      }}
