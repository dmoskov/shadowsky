  ...
  try {
    ...
    const colorCheck = await page.evaluate(() => {
      ...
      return {
        ...
        colorNotificationLike: computed.getPropertyValue('--color-notification-like'),
        ...
        headerBg: document.querySelector('.header') ? 
          getComputedStyle(document.querySelector('.header')).backgroundColor : null,
      };
    });
    ...
    console.log('   --danger-color (should be empty):', colorCheck.dangerColor || '✅ REMOVED');
