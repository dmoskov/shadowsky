...
async function testDesignImprovements() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        `Header: ${hasHeader}, Sidebar: ${hasSidebar}, Feed: ${hasFeed}`,
      );
    }
    ...
    const spacing = await postCard.evaluate(
    ...
    const hoverBg = await postCard.evaluate(
    ...
    const tooltipVisible = await page
      .locator('.tooltip-container:has-text("Like")')
      .isVisible();
    ...
    await page.screenshot({
      path: "test-screenshots/design-improvements-desktop.png",
      fullPage: false,
    });
    ...
    await page.waitForTimeout(300);
    await page.screenshot({
      path: "test-screenshots/design-improvements-mobile.png",
      fullPage: false,
    });
    ...
    await page.screenshot({
      path: "test-screenshots/design-improvements-hover.png",
      fullPage: false,
    });
    ...
    await page.screenshot({
      path: "test-screenshots/design-improvements-error.png",
      fullPage: true,
    });
  } finally {
    await browser.close();
