...
import {RepostsScreen} from '../../../../src/screens/shared/RepostsScreen';
import {ErrorState} from '../../../../src/components/ErrorState';

export default function PostRepostsRoute() {
  ...
  return (
    <>
      ...
      />
      <RepostsScreen postUri={decodedUri} onNavigateToProfile={handleNavigateToProfile} />
    </>
  );
}
