#!/usr/bin/env node
/**
 * Script to update imports to use the shared package
 */
...
const mappings = {
  // Services
  '../services/atproto': '@bsky/shared/services/atproto',
  '../../services/atproto': '@bsky/shared/services/atproto',
  '../../../services/atproto': '@bsky/shared/services/atproto',
...
async function main() {
  ...
  console.log('Updating imports to use @bsky/shared package...')
